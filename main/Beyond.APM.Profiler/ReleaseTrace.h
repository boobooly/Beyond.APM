...
//	    CReleaseTrace()
//	    {
//			PREFIX = "BeyondAPM: (Profiler) ";
//			WPREFIX = L"BeyondAPM: (Profiler) ";
//	}
//
//	const char* PREFIX ;//= "BeyondAPM: (Profiler) ";
//	const wchar_t* WPREFIX;// = L"BeyondAPM: (Profiler) ";
//
//#pragma warning(push)
