...
//
//  boobooly
//  offer clr infos by ICorProfilerInfo Interface, Partial implimenation of ClrProfiler.h
//
...
/// </summary>
std::wstring CClrProfiler::GetModulePath(ModuleID moduleId)
{
...
/// </summary>
std::wstring CClrProfiler::GetAssemblyName(AssemblyID assemblyId)
{
    ULONG dwNameSize = 512; 
...
mdSignature CClrProfiler::GetMethodSignatureToken_I4(ModuleID moduleID)
{
...
HRESULT CClrProfiler::GetModuleRef(ModuleID moduleId, WCHAR*moduleName, mdModuleRef &mscorlibRef)
{
    CComPtr<IMetaDataEmit> metaDataEmit;
...
HRESULT CClrProfiler::GetModuleRef4000(IMetaDataAssemblyEmit *metaDataAssemblyEmit, WCHAR*moduleName, mdModuleRef &mscorlibRef)
{
...
HRESULT CClrProfiler::GetModuleRef2000(IMetaDataAssemblyEmit *metaDataAssemblyEmit, WCHAR*moduleName, mdModuleRef &mscorlibRef)
{
    ASSEMBLYMETADATA assembly;
    ZeroMemory(&assembly, sizeof(assembly));
...
HRESULT CClrProfiler::GetModuleRef2050(IMetaDataAssemblyEmit *metaDataAssemblyEmit, WCHAR*moduleName, mdModuleRef &mscorlibRef)
{
    ASSEMBLYMETADATA assembly;
    ZeroMemory(&assembly, sizeof(assembly));
    assembly.usMajorVersion = 2;
